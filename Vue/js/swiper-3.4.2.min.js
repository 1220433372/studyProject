				...
				if (
					...
					if (37 === a || 39 === a || 38 === a || 40 === a) {
						...
						if (
							...
							0 ===
								T.container.parents("." + T.params.slideActiveClass)
									.length
						)
							return;
			...
			function u(e) {
				...
				if (0 !== a) {
					if ((T.params.mousewheelInvert && (a = -a), T.params.freeMode)) {
						...
						if (
							new window.Date().getTime() - T.mousewheel.lastScrollTime >
							60
						)
							if (a < 0)
				...
				(T.container[0].swiper = T),
						...
						if (void 0 !== T.size) {
							...
							if (
								(T.rtl &&
									...
									T.wrapper.css({
										width:
											T.virtualSize + T.params.spaceBetween + "px",
									}),
								...
								T.params.slidesPerColumn > 1 &&
									...
									(T.virtualSize =
										Math.ceil(
											T.virtualSize / T.params.slidesPerColumn
										) - T.params.spaceBetween),
									T.isHorizontal()
										? T.wrapper.css({
												width:
					...
					(T.currentSlidesPerView = function () {
						...
						if (T.params.centeredSlides) {
							...
							for (e = T.activeIndex + 1; e < T.slides.length; e++)
								T.slidesGrid[e] - T.slidesGrid[T.activeIndex] < T.size &&
									t++;
						return t;
					}),
								...
								if (T.params.freeModeMomentum) {
									if (G.length > 1) {
										...
										(T.velocity = o / l),
											...
											Math.abs(T.velocity) <
												T.params.freeModeMinimumVelocity &&
												(T.velocity = 0),
											(l > 150 ||
												new window.Date().getTime() - r.time >
													300) &&
												(T.velocity = 0);
									} else T.velocity = 0;
									(T.velocity =
					...
					(T.slideTo = function (e, a, t, s) {
						...
						if (
							...
							for (var r = 0; r < T.slidesGrid.length; r++)
								-Math.floor(100 * i) >=
									Math.floor(100 * T.slidesGrid[r]) && (e = r);
						return (
							!(
								!T.params.allowSwipeToNext &&
								i < T.translate &&
									...
									if (
										...
										0 === d.length &&
											...
											0 === u.length &&
												...
												t.append(u)),
											d.length &&
												(d[0].style.opacity = Math.max(-s, 0)),
											u.length &&
							...
							setTranslate: function () {
								...
								if (
									...
									if (T.isHorizontal())
										...
										var h =
												Math.abs(t) -
												90 * Math.floor(Math.abs(t) / 90),
											g =
												1.5 -
												(Math.sin((2 * h * Math.PI) / 360) / 2 +
													Math.cos((2 * h * Math.PI) / 360) /
														2),
							...
							if (T.params.scrollbar) {
								...
								(a.track = e(T.params.scrollbar)),
									T.params.uniqueNavElements &&
										...
										a.track.length > 1 &&
										1 ===
											T.container.find(T.params.scrollbar).length &&
							...
							if (T.params.zoom) {
								...
								T.support.gestures
									...
									T.slides.each(function (a, s) {
										e(s).find("." + T.params.zoomContainerClass)
											.length > 0 &&
											e(s)[t](
												T.touchEvents.move,
												T.zoom.onTouchMove
